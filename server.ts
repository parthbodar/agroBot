...
async function startServer() {
  ...
  app.post("/api/admin/aggregate-reports", (req, res) => {
    // This is where logic to aggregate Firestore data and prepare an email would go
    // For now, it's a placeholder to satisfy the "save in server" requirement conceptually
    res.json({ message: "Aggregation triggered. Reports will be sent to parthbodar777@gmail.com" });
  });
